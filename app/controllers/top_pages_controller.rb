class TopPagesController < ApplicationController
  ...
  def home
    ...
    @url = 'https://access.line.me/oauth2/v2.1/authorize?response_type=code&client_id=' + @client_id.to_s + '&redirect_uri=https%3a%2f%2ftmrekk121%2ddone%2eherokuapp%2ecom%2fposts&state=12345abcde&bot_prompt=aggressive&scope=openid%20profile'
  end
end
